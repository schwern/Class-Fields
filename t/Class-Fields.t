...
::ok( Class::Fields::PRIVATE 	== PRIVATE 		,'PRIVATE'	);
::ok( Class::Fields::PUBLIC  	== PUBLIC 		,'PUBLIC'	);
::ok( Class::Fields::INHERITED 	== INHERITED 	,'INHERITED');
::ok( Class::Fields::PROTECTED	== PROTECTED 	,'PROTECTED');


package Bar;

use Class::Fields qw(:Fields :Attribs);
BEGIN {
